    ...
    <div className={styles.page}>
      ...
      <div className={styles.aboutContent}>
        ...
        <div className={styles.aboutAlampuDescription}>
          ...
          <br />
          <br />
          Discover the joy of giving with <b>Alampu</b> — where every gift tells
          a story.
        </div>
        <div className={styles.meetTeamTitle}>Meet Our Team</div>
        <div className={styles.meetOurTeamDescription}>
          Alampu is your one-stop destination for all things gifting—whether
          it's corporate gifting, wedding favors, college souvenirs, or personal
          ...
          committed to making your gifting experience seamless and delightful.
          We carefully curate a diverse range of gifts, handling everything from
          product selection to packaging, delivery, and customer support—all
          with a personal touch.
          <br />
          <br />
          As a growing team, we strive to make gifting hassle-free and
          meaningful. Join us in celebrating the joy of thoughtful gifting!
        </div>
      </div>
    </div>
  );
